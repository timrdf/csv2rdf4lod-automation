...
while [[ $# -ge 1 ]]; do
   if   [[ $1 == "cr:directory-of-sources" || $1 == "cr:data-root"          ]]; then
      ...
      echo "  You can run this from a directory of datasets"
      echo "  (e.g. \$whatever/source/mySOURCE/)."
   elif [[ $1 == "cr:dataset"                                               ]]; then
      echo ""
      echo "  Working directory does not appear to be a dataset."
      echo "  You can run this from"
      ...
      echo "  You can run this from a directory of versions"
