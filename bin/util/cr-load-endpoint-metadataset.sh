#!/bin/bash
# 
# Usage: cr-virtuoso-load-metadataset.sh [-w] [-ng http://named-graph-for-endpoint] [source-id dataset-id]*
# See https://github.com/timrdf/csv2rdf4lod-automation/wiki/Aggregating-subsets-of-converted-datasets
# https://github.com/timrdf/csv2rdf4lod-automation/blob/master/bin/util/cr-virtuoso-load-metadataset.sh
