...
if [ "$1" != "CLEAR" ]; then
   ...
   echo "CSV2RDF4LOD_PUBLISH_SPARQL_ENDPOINT_SEPARATE_PROVENANCE_NG ${CSV2RDF4LOD_PUBLISH_SPARQL_ENDPOINT_SEPARATE_PROVENANCE_NG:-"(will default to: true)"}"
   ...
   export CSV2RDF4LOD_PUBLISH_SPARQL_ENDPOINT_SEPARATE_PROVENANCE_NG=""       
