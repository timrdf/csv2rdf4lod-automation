...
#3>    prov:specializationOf <https://github.com/timrdf/csv2rdf4lod-automation/blob/master/bin/dataset/cr-aggregate-void.sh>;
...
pushd `cr-conversion-root.sh` &> /dev/null
   ...
   # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
   echo "Aggregating all VoID metadata in `pwd` into $cockpit/source/." >&2
