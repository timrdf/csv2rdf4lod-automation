...
# hash-raw-to-same-frbr-expression-as-csv 2011-Sep-09 ()
#--------------------------------------------------------------
...
datasetID="hash-raw-to-same-frbr-expression-as-csv"             # Came from directory name ../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
datasetVersion="2011-Sep-09"        # DEPRECATED
versionID="2011-Sep-09"             # Came from directory name ../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions) renaming datasetVersion (deprecating datasetVersion)
...
#-----------------------------------
# manual/just-data.csv
sourceDir="manual"
datafile="just-data.csv"
