#!/bin/bash
# delimits-object-pipe 2011-Apr-21 ()
#--------------------------------------------------------------
...
sourceID="lebot"
datasetID="delimits-object-pipe"
datasetVersion="2011-Apr-21"        # NO SPACES; Use curl -I -L http://www.data.gov/download/delimits-object-pipe/csv | grep Last-Modified: | awk '{printf(%s-%s-%s,,,)}'
versionID="2011-Apr-21"             # renaming datasetVersion (deprecating datasetVersion)
