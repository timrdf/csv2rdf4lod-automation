...
# scientific-ocean-drilling-repository-dspace 2011-Oct-17 ()
#--------------------------------------------------------------
...
sourceID="iodp-org"               # Came from directory name ../../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
datasetID="scientific-ocean-drilling-repository-dspace"             # Came from directory name ../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
datasetVersion="2011-Oct-17"        # DEPRECATED
versionID="2011-Oct-17"             # Came from directory name ../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions) renaming datasetVersion (deprecating datasetVersion)
...
#-----------------------------------
# source/sandboxMeta.csv
sourceDir="source"
datafile="sandboxMeta.csv"
